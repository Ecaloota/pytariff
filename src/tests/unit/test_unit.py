...
#     metric: Any, direction: TradeDirection, convention: SignConvention, raises: bool
# ) -> None:
#     if raises:
#         with pytest.raises(ValidationError):
#             ConsumptionUnit(metric=metric, direction=direction, convention=convention)
#     else:
#         assert ConsumptionUnit(
#             metric=metric, direction=direction, convention=convention
#         )
