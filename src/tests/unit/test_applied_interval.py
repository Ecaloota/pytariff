...
# from pytariff.time_period import AppliedInterval
...
#             GENERIC_TZ,
#             DaysApplied(
#                 day_types=(DayType.HOLIDAYS,),
#                 holidays=country_holidays("AUS", subdiv="ACT", years=2020),
#             ),
#         ),
#         (
#             date(2023, 1, 2),
...
#             GENERIC_TZ,
#             DaysApplied(
#                 day_types=(DayType.BUSINESS_DAYS,),
#                 holidays=country_holidays("AUS", subdiv="ACT", years=2020),
#             ),
#         ),
#     ],
...
#             GENERIC_TZ,
#             DaysApplied(
#                 day_types=(DayType.TUESDAY, DayType.HOLIDAYS),
#                 holidays=country_holidays("AUS", years=2020),
#             ),
#         ),
#     ],
# )
