...
# from old.typing import Consumption, Demand
# from pytariff.core.block import ConsumptionBlock, DemandBlock, TariffBlock
# from pytariff.core.charge import (
#     ConsumptionCharge,
...
# from pytariff.core.unit import (
#     ConsumptionUnit,
#     DemandUnit,
#     SignConvention,
#     TariffUnit,
...
#     ],
# )
# def test_consumption_charge_cannot_intersect(
#     blocks_tuple: tuple[ConsumptionBlock, ...],
# ) -> None:
#     """"""
...
#             )
#     else:
#         assert ImportConsumptionCharge(
#             blocks=blocks_tuple, unit=unit, reset_data=reset_data
#         )
...
#             )
#     else:
#         assert ExportConsumptionCharge(
#             blocks=blocks_tuple, unit=unit, reset_data=reset_data
#         )
...
#                 blocks=(
#                     ConsumptionBlock(rate=None, from_quantity=50, to_quantity=100),
#                 ),
#                 unit=ConsumptionUnit(
#                     metric=Consumption.kWh,
#                     direction=TradeDirection.Import,
...
#                 reset_data=ResetData(
#                     anchor=datetime(2023, 1, 1, tzinfo=ZoneInfo("UTC")),
#                     period=ResetPeriod.HALF_HOURLY,
#                 ),
#             ),
#             False,
#         ),
#     ],
# )
# def test_tariff_charge_hash(
#     charge_a: TariffCharge, charge_b: TariffCharge, is_equal: bool
# ) -> None:
