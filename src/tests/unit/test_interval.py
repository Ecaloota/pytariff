...
# from pytariff.core.day import DaysApplied, DayType
# from pytariff.core.interval import ConsumptionInterval, DemandInterval, TariffInterval
...
#     ],
# )
# def test_tariff_interval_valid_construction(
#     block: ConsumptionBlock | DemandBlock, is_valid: bool
# ) -> None:
#     if is_valid:
#         TariffInterval(
#             start_time=time(6),
...
#     ],
# )
# def test_demand_interval_charges_must_be_demand_charges(
#     charge: ConsumptionCharge | DemandCharge, raises: bool
# ) -> None:
#     if raises:
#         with pytest.raises(ValidationError):
...
#     ],
# )
# def test_tariff_interval_hash(
#     interval_a: TariffInterval, interval_b: TariffInterval, is_equal: bool
# ) -> None:
